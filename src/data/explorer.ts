...
export const explorerData: ExplorerType[] = [
	...
	{
		txHash:
			'0xa72dd790de38114e95fbc98477605caf3e26f1a48963f9b5aaeebd5613cf48b3',
		type: {
	...
	{
		txHash:
			'0xc93dd790de38114e95fbc98477605caf3e26f1a48963f9b5aaeebd5613cf48f4',
		type: {
	...
	{
		txHash:
			'0xe85dd790de38114e95fbc98477605caf3e26f1a48963f9b5aaeebd5613cf48d9',
		type: {
			txType: ActionType.DEPOSIT,
			txStatus: ActionStatus.PENDING,
		},
	...
	{
		txHash:
			'0xg26dd790de38114e95fbc98477605caf3e26f1a48963f9b5aaeebd5613cf48f1',
		type: {
			txType: ActionType.VOUCH,
			txStatus: ActionStatus.PENDING,
		},
	...
	{
		txHash:
			'0xh37dd790de38114e95fbc98477605caf3e26f1a48963f9b5aaeebd5613cf48c2',
		type: {
			txType: ActionType.DEPOSIT,
			txStatus: ActionStatus.FAILED,
		},
	...
	{
		txHash:
			'0xj59dd790de38114e95fbc98477605caf3e26f1a48963f9b5aaeebd5613cf48a1',
		type: {
			txType: ActionType.WITHDRAW,
			txStatus: ActionStatus.FAILED,
		},
